...
<t:loggedInAsCustomer>
    ...
    <%--  HERO END  --%>
    <form action="BuilderServlet" method="post" class="mb-0 needs-validation" novalidate>
            ...
            <div class="gap-4 w-100" style="max-width: 600px">
                <div class="d-flex flex-column gap-3">
                    ...
                    <div class="position-relative">
                        ...
                        <div>
                            <select class="form-select ${requestScope.widthErrorClass}" id="carportWidth" required name="carportWidth">
                            ...
                            ${requestScope.widthErrorMessage}
                        </div>
                    </div>
                    <div class="position-relative">
                        <label for="carportLength" class="form-label">Længde af carport</label>
                        <div>
                            <select class="form-select ${requestScope.lengthErrorClass}" id="carportLength" required name="carportLength">
                            ...
                            ${requestScope.lengthErrorMessage}
                        </div>
                    </div>
                    <div class="position-relative">
                        <label for="shedWidth" class="form-label">Bredde af skur</label>
                        <div>
                            <select class="form-select ${requestScope.shedWidthErrorClass}" id="shedWidth" name="shedWidth" required>
                            ...
                            ${requestScope.shedWidthErrorMessage}
                        </div>
                    </div>
                    <div class="position-relative">
                        <label for="shedLength" class="form-label">Længde af skur</label>
                        <div>
                            <select class="form-select ${requestScope.proportionsErrorClass}" id="shedLength" name="shedLength" required>
                                <option selected value="0">Intet skur</option>
                            ...
                            ${requestScope.proportionsErrorMessage}
                            ${requestScope.shedLengthErrorMessage}
                        </div>
                    </div>
